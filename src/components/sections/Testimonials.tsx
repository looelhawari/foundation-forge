...
const testimonials = [
  ...
  {
    id: 2,
    quote: "Working with Al-Rashid has been a pleasure. Their team's expertise in infrastructure development is unmatched, and they consistently exceed our expectations.",
