...
const Certificates = () => {
    const [selectedCert, setSelectedCert] = useState<typeof certificateData[0] | null>(null);
                        ...
                        {certificateData.map((cert, index) => (
                            ...
                            >
                                ...
                                <h3 className="font-display text-xl md:text-2xl text-foreground mb-3">
                                    {t(`documents.${cert.key}.title`)}
                                </h3>
                                <p className="text-muted-foreground text-sm mb-4 leading-relaxed">
                                    {t(`documents.${cert.key}.description`)}
                                </p>
            ...
            <section className="py-16 bg-muted/30">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-12">
                        {(['yearsInBusiness', 'projectsCompleted', 'activeCertifications', 'complianceRate'] as const).map((statKey, index) => (
                            <motion.div
                                key={statKey}
