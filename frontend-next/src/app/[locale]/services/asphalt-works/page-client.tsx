...
export default function AsphaltWorksPageClient() {
    const t = useTranslations('services.asphalt');
                        ...
                        <div className="grid md:grid-cols-4 gap-6">
                            {processSteps.map((s) => (
                                <div key={s.key} className="text-center">
                                    <div className="text-4xl font-bold text-primary/30 mb-2">{t(`processSection.${s.key}.step`)}</div>
                                    <h3 className="font-display text-lg mb-2">{t(`processSection.${s.key}.title`)}</h3>
                                    <p className="text-sm text-muted-foreground">{t(`processSection.${s.key}.desc`)}</p>
                                </div>
                            ))}
                        </div>
                    </div>
