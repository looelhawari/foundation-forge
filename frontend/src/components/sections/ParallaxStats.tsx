...
const statsData = [
  ...
  { value: 26, suffix: "M+", label: "TOTAL PROJECT VALUE (QR)" },
  { value: stats.satisfiedClients, suffix: "+", label: "SATISFIED CLIENTS" },
];
        ...
        >
          ...
          <div className="overflow-hidden">
            <motion.h2
              ...
              className="font-display text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl tracking-[0.05em] px-4"
            >
