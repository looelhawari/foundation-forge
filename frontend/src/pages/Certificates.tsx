...
const certificates = [
    {
        ...
        description: "Official commercial registration certificate valid until December 2029",
    ...
    },
    {
        id: 2,
        title: "Computer Card",
        description: "Company computer card registration certificate valid until 2028",
        validUntil: "2028",
        file: computerCard,
        icon: Award,
                    ...
                    <div className="container mx-auto px-6 relative z-10">
                        ...
                        >
                            ...
                            <p className="text-lg text-muted-foreground leading-relaxed">
                                Access our official company documents and certifications. All documents are
                                verified and up-to-date, demonstrating our commitment to transparency and compliance.
                            </p>
                        </motion.div>
                    </div>
                </section>
                    ...
                    <div className="container mx-auto px-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                            {certificates.map((cert, index) => (
                                ...
                                >
                                    {/* Icon */}
                                    <div className={`w-14 h-14 rounded-xl bg-gradient-to-br ${cert.color} flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300`}>
                    ...
                    <div className="container mx-auto px-6">
                        ...
                        >
                            ...
                            <p className="text-muted-foreground leading-relaxed">
                                At CPC Qatar, we believe in complete transparency. All our business operations
                                are fully licensed and compliant with Qatar's regulatory requirements. These
                                documents verify our legitimacy and commitment to operating with integrity.
                            </p>
                        </motion.div>
